...
function Network.TestLoginBinary(buffer)
	...
	Log.i('TestLoginBinary: protocal:>'..protocal..' str:>'..str)
end
...
function Network.TestLoginPblua(buffer)
	...
	Log.i('TestLoginPblua: protocal:>'..protocal..' msg:>'..msg.id)
end
...
function Network.TestLoginPbc(buffer)
	...
	Log.i('TestLoginPbc: protocal:>'..protocal)
end
...
function Network.TestLoginSproto(buffer)
    ...
    print_r(addr)
	Log.i('TestLoginSproto: protocal:>'..protocal)
end
